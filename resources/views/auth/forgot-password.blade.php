{{--
    ...
    Disamakan dengan style halaman login/register
--}}
@extends('layouts.app')
...
<div class="auth-page">
    <div class="auth-card">
        ...
        <div class="auth-subtitle">Masukkan email Anda untuk menerima tautan reset password</div>
        ...
        <div class="auth-footer">
            Ingat password Anda?
            <a href="{{ route('login') }}" style="color:#0d5c45;font-weight:700">Kembali ke login</a>
        </div>
    </div>
</div>
